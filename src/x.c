...
void x_window_kill(xcb_window_t window, kill_window_t kill_window) {
    ...
    if (kill_window == KILL_WINDOW_FORCE || kill_window == KILL_CLIENT_FORCE || !window_supports_protocol(window, A_WM_DELETE_WINDOW)) {
        if (kill_window == KILL_WINDOW || kill_window == KILL_WINDOW_FORCE) {
...
void x_draw_decoration(Con *con) {
    ...
    const int title_padding = logical_px(con->title_padding);
